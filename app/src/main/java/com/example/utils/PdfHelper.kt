...
object PdfHelper {
    ...
    private fun drawDocument(
        ...
        val grandTotal = com.example.domain.engine.AggregationEngine.calculateGrandTotal(rooms)
        ...
        val breakdown = com.example.domain.engine.AggregationEngine.generateCategoryBreakdown(rooms)
