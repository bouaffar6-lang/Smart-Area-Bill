package com.aistudio.smartareabill.data.models
...
data class WorkItem(
    ...
    fun getQuantity(room: RoomEntity): Double {
        ...
        return com.aistudio.smartareabill.domain.engine.QuantityEngine.calculateQuantity(
    ...
    fun getCost(room: RoomEntity): Double {
        return com.aistudio.smartareabill.domain.engine.PricingEngine.calculateCost(getQuantity(room), unitPrice)
    }
}
