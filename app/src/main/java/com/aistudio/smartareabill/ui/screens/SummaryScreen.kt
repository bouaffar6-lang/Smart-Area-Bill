package com.aistudio.smartareabill.ui.screens
...
import com.aistudio.smartareabill.R
import com.aistudio.smartareabill.data.models.RoomEntity
import com.aistudio.smartareabill.utils.PdfHelper
...
fun SummaryScreen(
    ...
    // Engineering Totals
    val grandTotalBill = com.aistudio.smartareabill.domain.engine.AggregationEngine.calculateGrandTotal(rooms)
        ...
        LazyColumn(
            ...
            item {
                val breakdown = remember(rooms) {
                    com.aistudio.smartareabill.domain.engine.AggregationEngine.generateCategoryBreakdown(rooms)
                }
